...
global max_speed_angular
global dis_desired
global max_speed_linear
global depth_center_last
        ...
        while not rospy.is_shutdown():
            if ic.rect_done:
                ...
                if class_num==14:
                    ...
                    if dis < 0:
                        dis *=2
                    linear_x = dis * 0.4 * max_speed_linear 
                    #print(angular_z)
                twist = Twist()
                twist.linear.x=linear_x/3
                twist.angular.z=angular_z/3
